    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="listagerencias.php">Listado Gerencias</a>
            <a class="collapse-item" href="listaOficinas.php">Listado Sub Gerencias</a>
            <a class="collapse-item" href="listaAreas.php">Listado Areas</a>
            <a class="collapse-item" href="listaCargos.php">Listado Cargos</a>
            <a class="collapse-item" href="listadoActividades.php">Listado Actividades</a>
          </div>
        </div>
      </li>
