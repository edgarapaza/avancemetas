CREATE DATABASE  IF NOT EXISTS `avancemetas` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `avancemetas`;
...
INSERT INTO `actividades` VALUES (1,1,3,14,117,'Reuniones de Trabajo','Numero','2016-06-09 17:35:27',NULL),(2,25,5,15,109,'Expedicion de Resoluciones','Numerico','2016-06-09 20:39:46','ninguno'),(3,25,5,15,109,'Expedicion de Resoluciones','Numerico','2016-06-09 20:41:12','ninguno'),(4,25,6,18,113,'Consultas Juridicas','Numerico','2016-06-09 20:41:48',''),(5,1,4,16,108,'Ordenamiento de Legajos','Metros','2016-06-09 20:43:08',''),(6,10,4,16,112,'Organizacion Documental','Metros','2016-06-09 20:44:12',''),(7,3,3,14,105,'Elaboracion de Documentos de Gestión','Numerico','2016-06-10 16:40:30',''),(8,6,2,11,101,'Reuniones de trabajo','Numerico','2016-06-10 16:42:42',''),(9,19,4,16,109,'Elaboracion de Documentos de Gestión','Numerico','2016-06-10 16:43:41',''),(10,8,4,14,107,'Control de Inventarios','Numerico','2016-06-10 16:44:19',''),(11,1,2,13,102,'Reuniones de trabajo','Porcentaje','2016-06-10 16:46:33',''),(12,15,4,15,111,'Recepcion de documentos','Numerico','2016-06-10 17:06:31','');
...
INSERT INTO `login` VALUES (1,'edgar','edgar','2016-06-06 00:43:22',20,10,5),(2,'felix','123','2016-06-06 00:43:22',2,11,3),(3,'jorge','2016','2016-06-09 22:06:48',6,13,3);
...
CREATE TABLE `reportes` (
  ...
  `reporte` double NOT NULL DEFAULT '0',
  `estado` tinyint(4) NOT NULL DEFAULT '0',
  `obs` varchar(400) DEFAULT NULL,
  `fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`idreportes`),
  KEY `fk_reporte_personal_idx` (`idpersonal`),
  KEY `fk_reporte_actividades_idx` (`idactividad`),
  CONSTRAINT `fk_reporte_actividades` FOREIGN KEY (`idactividad`) REFERENCES `actividades` (`idActividad`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_reporte_personal` FOREIGN KEY (`idpersonal`) REFERENCES `personal` (`id_personal`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reportes` VALUES (1,1,1,2,1,NULL,'2016-06-10 19:21:39'),(2,1,5,0,0,NULL,'2016-06-10 19:22:13'),(3,25,2,0,0,NULL,'2016-06-10 19:23:04'),(4,25,3,16,1,NULL,'2016-06-10 19:23:04'),(5,25,4,0,0,NULL,'2016-06-10 19:23:04'),(6,6,8,34,1,'obs','2016-06-10 19:23:56');
